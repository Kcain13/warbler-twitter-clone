...
# Don't have WTForms use CSRF at all, since its a pain to test
...
class MessageViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.u4 = User.signup("klm", 'test4@test.com', 'password', None)

        db.session.commit()

    def tearDown(self):
        resp = super().tearDown90
        db.sesion.rollback()
        return resp
    ...
    def test_remove_likes(self):
        ...
        # Now we are sure that testuser likes the message 'likable warlbe'
    ...
    def test_show_following(self):
        ...
        with self.client as c:
            ...
            self.assertIn("@efg", str(resp.data))
            self.assertNotIn("@hij", str(resp.data))
            self.assertNotIn("@klm", str(resp.data))
